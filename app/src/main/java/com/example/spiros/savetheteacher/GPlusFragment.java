...
public class GPlusFragment extends android.support.v4.app.Fragment implements GoogleApiClient.OnConnectionFailedListener {
...
//            Intent goOn = new Intent(GPlusFragment.this.getActivity(),MainActivity.class);
//            startActivityForResult(goOn, 0);
            // User is signed in
            Log.d(TAG, "onAuthStateChanged:signed_in:" + name);

            signInButton.setVisibility(View.GONE);
          // signOutButton.setVisibility(View.VISIBLE);
            Intent signInToMain = new Intent(GPlusFragment.this.getActivity(),MainActivity.class);
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                try {
                    ...
                    Operations operations = new Operations(getContext());
...
//login
                    ...
                    new GPlusFragment.MyAsyncTaskgetNews().execute(url);
                }
